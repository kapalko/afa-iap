...
class DroneDuel(UnityToGymWrapper, MultiAgentEnv):
    def __init__(
        self,
        # [General arguments]
        worker_id: int = 0,
        ...
        drone_pos_min: float = 10,
        drone_pos_max: float = 15,
        ...
        if env_build is None:
            if sys.platform == "darwin":
                env_build = os.path.join(dirname, '../../builds/DroneDuel/Mac')
            elif sys.platform == 'win32':
                env_build = os.path.join(dirname, '..\\..\\builds\\DroneDuel\\Windows\\DroneDuel.exe')
            elif sys.platform == 'linux':
                env_build =  os.path.join(dirname, '../../builds/DroneDuel/Linux/DroneDuel.x86_64')
        ...
        self.channel.set_float_parameter('drone_pos_min', drone_pos_min)
        self.channel.set_float_parameter('drone_pos_max', drone_pos_max)
        self.channel.set_float_parameter('random_seed', random_seed)

        # Instantiate gym-unity
        super(DroneDuel, self).__init__(unity_env=unity_env,
